...
public class CaptureData {
    ...
    public float LightHealth { get; private set; }
    public float DarkHealth { get; private set; }
    ...
    /// <param name="lightHealth">The health of the light pieces</param>
    /// <param name="darkHealth">The health of the dark pieces</param>
    /// <param name="turn">Which team's turn is it</param>
    public CaptureData(Move captureMove, EPieceType light, EPieceType dark, float lightHealth, float darkHealth, int turn) {
